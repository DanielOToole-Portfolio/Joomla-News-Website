...
function iCagendaBuildRoute( &$query )
{
	...
	// DEPRECATED (since 3.6.0): link event
...
//		unset($query['id']);
	...
	// DEPRECATED (since 3.6.0): link registration
...
//		$vars['id'] 	= $segments[0];
	...
	// Routing actions from list (to be refactored)
	...
	// DEPRECATED (since 3.6.0): Routing registration form (2 segment: ID, view)
	...
	// DEPRECATED (since 3.6.0): List of events
...
//	}
	...
	// DEPRECATED : Routing event details view (1 segment: ID)
