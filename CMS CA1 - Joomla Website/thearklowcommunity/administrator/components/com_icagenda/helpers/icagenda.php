...
// @TODO: check later. Removed due to conflict with Joomla 3.7 new plugin system fields (custom fields) loading admin helper in frontend... :-|
// Access check.
