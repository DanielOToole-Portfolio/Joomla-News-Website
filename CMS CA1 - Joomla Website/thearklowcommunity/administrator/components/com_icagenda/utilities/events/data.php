 ...
 *
 * DEPRECATED and TO BE REMOVED in 4.0
 */
class icagendaEventsData
{
	/**
	...
	public static function getAllDates($filterTime = null, $datesDisplay = null, $orderby = null, $mcatid = null, $moduleParams = false)
	{
		...
		if ( ! $moduleParams)
		{
			$menu_search_filters = $app->getMenu()->getActive()->params->get('search_filters');
				...
				)
			{
				if ($only_startdate)
				{
						...
						)
					{
						...
						if (in_array($filterTime, array('1', '4'))
