...
//		$attr .= $this->multiple ? ' multiple' : '';
		$attr .= ' multiple'; // Not use of multiple xml attribute due to bug with 'showon' in Joomla 3.2.4 > 3.4.1
		...
		$html.= '<div class="alert alert-info" style="margin-top: 10px; margin-left: -15px;">';
