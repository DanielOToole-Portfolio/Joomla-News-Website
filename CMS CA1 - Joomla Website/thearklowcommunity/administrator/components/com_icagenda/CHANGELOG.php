...
================================================================================
? <center><strong><big>Welcome to iCagenda 3.6.12 release!</big></strong></center><br /><p><strong>Faster and more flexible, do more with iCagenda!</strong></p><p>iCagenda 3.6 introduces Frontend Search Filters, new Custom Field edition with more field types and more flexibility (core fields override, custom field groups...), a full refactory of the main list of events, statistics for event clicks, and more...</p><p>Update and take advantage of all the improvements done in lastest version of iCagenda!</p><p><strong>Enjoy!</strong></p><br /><u>Note</u>: 3.6.12 is a maintenance release with a few improvements and bug fixes. See the release notes for details.<br />
================================================================================
